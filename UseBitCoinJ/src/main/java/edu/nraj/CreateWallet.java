...
public class CreateWallet {
	public static void myCreateWallet() throws UnknownHostException{
		final NetworkParameters walletNetParams = TestNet3Params.get(); 
		BlockStore blockStore = new MemoryBlockStore(walletNetParams); 
		Wallet wallet = null;
		File testFile = new File("newTest.wallet");
		File testFile2 = new File("test.wallet");
	try {
			try {
